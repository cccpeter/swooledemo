...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "23533574"; // AccessKeyId

        $accessKeySecret = "6b83f50be2c729481802a688e8152a14"; // AccessKeySecret
    ...
    public static function sendSms($phone, $code) {
        ...
        $request->setSignName("书store");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_60380404");
